...
package body Radar_Internals is
   ...
   begin
      ...
      if Active_Object_Distance < 5.0
        and then Active_Object_Status = Out_Of_Range
      then
   ...
   is
      pragma Unreferenced (Radar_Angle);
      E_T_A_H : constant Integer
        := Integer (Float'Floor (Time_To_Arrival / 3600.0));
      E_T_A_M : constant Integer
        := Integer (Float'Floor (Time_To_Arrival / 60.0)) mod 60;
